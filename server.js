...
// Verificación inicial de archivos (SOLO si no existen)
if (!fs.existsSync(votosPath)) {
  console.log("⚠️ Archivo votos.json no encontrado. Creando un archivo nuevo.");
  ...
  console.log("✅ Archivo votos.json cargado correctamente.");
}
...
const getVotos = () => {
  console.log("📥 Leyendo votos desde votos.json");
...
const guardarVotos = (votos) => {
  console.log("💾 Guardando votos:", votos);
